...
// SignatureExperiencesForm.tsx
"use client";

import { Form, Input, Button, Select, Upload, InputNumber, DatePicker, TimePicker } from "antd";
import { UploadOutlined, PlusOutlined } from "@ant-design/icons";
import { useState } from "react";

export default function SignatureExperiencesForm() {
  ...
  const handlePublish = () => {
    form.validateFields().then((values) => {
      console.log("Signature Experience submitted:", values);
    });
  };
    ...
    <Form form={form} layout="vertical" className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="space-y-4">
          ...
          >
            <Input.TextArea
              placeholder="Enter experience short description"
              rows={2}
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter experience price" },
            ]}
          >
            <InputNumber
              prefix="$"
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <Form.Item name="experienceImages">
          <Upload.Dragger
            multiple
            beforeUpload={() => false}
            className="p-6"
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        >
          <Input.TextArea
            placeholder="Enter detailed experience description"
            rows={4}
            className="rounded-lg border border-[rgba(0,0,0,0)] bg-[#F3F3F5]"
          />
        </Form.Item>
